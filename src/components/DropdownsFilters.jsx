  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        ...
        <Menu.Items
          className={`origin-bottom-right right-0 absolute h-auto max-h-56 overflow-y-auto z-10 mt-2 w-auto  rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`}
        >
          <div className="py-3 px-3">
            {props.options.options.map((item, index) => (
              <Menu.Item key={index}>
